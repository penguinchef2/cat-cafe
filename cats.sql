...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 27, 2026 at 05:02 PM
...
INSERT INTO `applications` (`id`, `full_name`, `phone`, `email`, `address`, `cat_id`, `household_size`, `pets`, `housing`, `status`, `userid`) VALUES
(1, 'poop1', '1291092', 'poop1@gmail.com', '1212 poop', 0, 1, 1, 'Own', 'approved', 5);
...
(2, 4, 5, 'cat stepped on my keyboard and sent an email to my boss', '2026-04-27 14:56:43'),
(3, 5, 4, 'one cat screamed at me but i think we understood each other', '2026-04-27 14:56:43'),
(4, 6, 5, 'this place healed something in me fr', '2026-04-27 14:56:43'),
(5, 7, 3, 'tried to adopt all of them. they said no. rude.', '2026-04-27 14:56:43'),
(6, 8, 5, 'the void cat stared into my soul and approved', '2026-04-27 14:56:43'),
(7, 9, 4, 'came for coffee, stayed because a cat fell asleep on me', '2026-04-27 14:56:43'),
(8, 10, 5, 'i am no longer a human, i belong to the cats now', '2026-04-27 14:56:43');
...
(6, 'catmom1@email.com', 'catqu3en', 'test123', 'Mia Paws'),
(7, 'zoomies@email.com', 'midnight_', 'test123', 'Jay Park'),
(8, 'tuna@email.com', 'tunabandit', 'test123', 'Luna Love'),
(9, 'napking@email.com', 'catn1p', 'test123', 'Theo Poop'),
(10, 'chaoscat@email.com', 'gremlinenergy', 'test123', 'Riley');
